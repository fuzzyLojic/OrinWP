...
<div class="wrapper-area">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'teczilla-dark' ); ?></a>
<div class="full-width-header">
    ...
    ?>
            <div class="menu-area tecdark menu-sticky <?php if(is_user_logged_in()) { ?> tec-stick <?php } ?>">
                <?php } else { ?>
                <div class="menu-area">
                    <?php } ?> 
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9 text-right">
                             <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Top Menu','teczilla-dark'); ?>">
